...
export function Login({ onEntrar, onRecuperar }:
  ...
  function enviar(e: FormEvent) {
    ...
    if (!m || !pass) { setError("Completá el correo y la contraseña para continuar."); return; }
    const c = CUENTAS.find((a) => a.mail === m && a.pass === pass);
    if (!c) { setError("No encontramos una cuenta con esos datos. Revisá el correo y la contraseña."); return; }
    setError(null);
    setEnviando(true);
    onEntrar(c.perfil);
  }
  ...
  return (
    <section className="screen login" aria-label="Iniciar sesión">
      ...
      <h1>Ingresá a CondoTrack</h1>
      <p className="sub">Accedé a la gestión de tu edificio: visitas, entregas, reservas y reclamos.</p>
      ...
      <form onSubmit={enviar} noValidate>
        ...
        <div>
          ...
          <div className="campo pw">
            <span className="glifo-campo"><Icon n="candado" s={19} w={1.8} /></span>
      ...
      <div className="ayuda">
        <p>¿Todavía no tenés acceso? El alta la hace la administración de tu edificio.</p>
        <p>Al ingresar aceptás los <b>Términos</b> y las <b>Políticas de privacidad</b> de CondoTrack.</p>
      </div>
    </section>
  );
}
